...
void usage(const char *arg0) {
  fprintf(stdout,
      ...
      "            /\\ \\/\\ \\/\\  == \\/\\  ___\\        "      " -n  --no-interact Don't redirect stdout to stderr for interactive editors\n"
      "            \\ \\ \\_\\ \\ \\  __<\\ \\  __\\        "     " -e  --editor      Editor of your choice, falls back to env vars if\n"
      "             \\ \\_____\\ \\_\\ \\_\\ \\_____\\      "     "                   none supplied\n"
